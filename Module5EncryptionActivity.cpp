...
std::string read_file(const std::string& filename)
{
    ...
    if (!file) {
        std::cerr << "Trouble opening file: " << filename << std::endl; // outputs error message to console
...
void save_data_file(const std::string& filename, const std::string& student_name, const std::string& key, const std::string& data)
{
    ...
    if (!file) { // if file was not created correctly, output error message
        std::cerr << "Trouble creating file: " << filename << std::endl;
        return;// exit
    }
    ...
    file << student_name << '\n'; //adding information to file according to file format
    file << timestamp << '\n';
    file << key << '\n';
    file << data;
    ...
    std::cout << "Data saved to file: " << filename << std::endl; // outputting successful message if data was saved to file
